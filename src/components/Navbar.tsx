  ...
  const clicked = () => {
    ...
    <nav className='flex items-center justify-between flex-wrap bg-teal-500 p-6'>
        <div className='flex items-center flex-shrink-0 text-white mr-6'>
            <Link to='/Home' className='font-semibold text-xl tracking-tight'>Digit</Link>
        </div>
        <div className='block'>
            <button
            onClick={dropDown}
             className="flex items-center px-6 py-2 text-teal-200 border rounded border-teal-400 
